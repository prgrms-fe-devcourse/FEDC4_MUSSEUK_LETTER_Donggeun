                ...
                <SwiperSlide key={slideContent._id} virtualIndex={index}>
                  <Box ml="4rem" mb="3.5rem" cursor="pointer">
                    <PostCard
                      ...
                      imgName={slideContent.musseukImageName}
                      musseukContent={slideContent.content}
                      musseukName={slideContent.musseukImageName}
                      userName={slideContent.author.username}
